...
public:
	...
	vector<GPU> GPUvect; // needs to be accessible outside of the class.
...
void removeMangSubMenu(Inventory&);
void addGPUMenu(Inventory&);
void removeGPUmenu(Inventory&);

void selectGPUmenu(Inventory&);
